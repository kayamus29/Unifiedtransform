        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4 pt-3">
                <div>
                    ...
                    <p class="text-muted small mb-0">Manage fee definitions and execute bulk term billing across all classes.</p>
                </div>
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-6 d-flex align-items-end justify-content-end pb-1">
                    <div class="input-group shadow-sm w-50">
                        ...
                        <input type="text" id="classSearch" class="form-control border-start-0" placeholder="Filter classes...">
                    </div>
                </div>
            </div>
            ...
            <div class="tab-content" id="feeTabsContent">
                <div class="tab-pane fade show active" id="definitions" role="tabpanel">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <span class="text-muted small">Session: <strong>{{ $currentSession->session_name }}</strong></span>
                    </div>
                                    ...
                                    <tr class="fee-row class-row" data-class-name="{{ $class->class_name }}">
                                        <td class="fee-cell">
                                            <div class="d-flex align-items-center">
                                                <i class="bi bi-building me-3 text-primary p-2 bg-light rounded shadow-sm"></i>
                                                <div>
                                            ...
                                            <td class="fee-cell text-center">
                                                <div class="d-flex flex-column align-items-center">
                                                    @if($count > 0)
                                                        ...
                                                        <button class="btn btn-sm btn-link p-0 text-decoration-none toggle-expand smallest" 
                                                    ...
                                                    @else
                                                        ...
                                                        <span class="text-danger smallest"><i class="bi bi-x-circle"></i> Missing</span>
                                                    @endif
                                                ...
                                                <div id="{{ $targetId }}" class="fee-details-container mt-3 text-start">
                                                    <div class="bg-light p-2 rounded border small">
                                                        @foreach($feeItems as $item)
                                                            <div class="d-flex justify-content-between mb-1 border-bottom border-white pb-1">
                                ...
                                <table class="table table-hover align-middle mb-0">
                                    ...
                                    <tbody>
                                        @forelse($billingHistory as $batch)
                                            <tr>
                                                <td class="ps-4">
                                                    <div class="fw-bold text-dark">{{ $batch->created_at->format('M d, Y') }}</div>
                                                    <div class="text-muted smaller">{{ $batch->created_at->diffForHumans() }}</div>
                                                </td>
                                                <td>{{ $batch->session->session_name }} - {{ $batch->semester->semester_name }}</td>
                                                <td class="text-center"><span class="badge bg-light text-dark border">{{ number_format($batch->student_count) }}</span></td>
                                                <td class="fw-bold text-success">₦{{ number_format($batch->total_amount, 2) }}</td>
                                                <td>
                                                    @if($batch->status == 'finalized')
                                                        <span class="badge bg-success-subtle text-success px-2 py-1"><i class="bi bi-shield-check me-1"></i> Finalized</span>
                                                    @else
                                                        <span class="badge bg-warning-subtle text-warning px-2 py-1">Locked</span>
                                                    @endif
                                                </td>
                                                <td><i class="bi bi-person-circle me-1"></i> {{ $batch->processor->first_name ?? 'System' }}</td>
                                            </tr>
                                        @empty
                                            <tr><td colspan="6" class="text-center py-5">No execution logs found.</td></tr>
                                        @endforelse
                                    </tbody>
                                </table>
                            </div>
...
<div class="modal fade" id="assignFeeModal" data-bs-focus="false" tabindex="-1" aria-labelledby="manageModalLabel" aria-hidden="true">
            ...
            <div class="modal-header bg-white border-0 pb-0">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <p class="text-muted small mb-0"><span id="target-class" class="fw-bold">...</span> | <span id="target-term" class="text-primary fw-bold">...</span></p>
                    </div>
                </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-5 border-end pe-md-4">
                        ...
                        <form id="manageFeeForm">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group shadow-sm">
                                    ...
                                    <input type="number" step="0.01" class="form-control border-light" name="amount" required>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label smallest uppercase fw-bold text-muted">Description</label>
                                <input type="text" class="form-control border-light shadow-sm bg-light" name="description" placeholder="Optional notes...">
                            </div>
                        ...
                        <div class="mt-4 p-3 bg-light rounded border border-white">
                            <h6 class="smallest fw-bold uppercase text-muted mb-2"><i class="bi bi-lightbulb"></i> Pro Tip</h6>
                            <p class="smallest mb-0">Use the "Copy" tool to duplicate these fees to other terms or parallel classes in seconds.</p>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered shadow-lg">
        <div class="modal-content border-0">
            <div class="modal-header border-0 pb-0 shadow-sm">
                <div class="d-flex align-items-center">
                    <div class="bg-warning-subtle p-2 rounded me-3"><i class="bi bi-lightning-charge text-warning fs-5"></i></div>
            ...
            <div class="modal-body py-4">
                ...
                <div class="d-flex justify-content-between px-5 mb-4 position-relative">
                    <div class="position-absolute translate-middle-y top-50 start-0 end-0 border-top mt-1" style="z-index: -1;"></div>
                ...
                <div id="wizard-step-1" class="wizard-step active">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="bulk_semester_id" class="form-select form-select-lg border shadow-sm" required>
                            ...
                            @foreach($semesters as $semester)
                                <option value="{{ $semester->id }}">{{ $semester->semester_name }} ({{ $currentSession->session_name }})</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="alert alert-info py-2 smallest">
                        <i class="bi bi-info-circle me-1"></i> System will calculate fees based on definitions for the selected term.
                    </div>
                ...
                <div id="wizard-step-3" class="wizard-step text-center py-4">
                    ...
                    <p class="text-muted small">You are about to post ledger entries for all active students. This operation is historical and permanent.</p>
                    ...
                    <form action="{{ route('accounting.fees.class.bulk_bill') }}" method="POST">
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-danger btn-lg px-5 shadow fw-bold" id="authorize-btn" disabled>
            ...
            <div class="modal-footer border-0 p-4 pt-0">
                <button type="button" class="btn btn-light px-4 border" id="prevStep" style="display: none;">Back</button>
                <div class="flex-grow-1"></div>
                <button type="button" class="btn btn-primary px-5 shadow" id="nextStep">Continue <i class="bi bi-arrow-right ms-1"></i></button>
            </div>
        </div>
    </div>
</div>
